...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to BTH Online Store!</h1>
                    <p>We have all in one place>
                </div>
            </div>
            <div class="container">
                <div class="row">
           ...
           <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy BTH  Rights Reserved. | Contact Us: +0000 00000</p>
